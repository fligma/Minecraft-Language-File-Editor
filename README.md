# Minecraft Language Editor

A lightweight desktop app built with PyQt6 for managing, creating, and editing Minecraft `.json` language files.

## Features

* **Spreadsheet Interface:** Edit translation keys and values in a simple table.
